...
<body class="bg-primary">
									...
									<form>
										<div class="form-group">
											...
											<input class="form-control py-4" id="inputEmailAddress"
												type="email" placeholder="Enter user name" />
										</div>
										<div class="form-group">
	...
	<script>
		$(".s2").on("click", function() {
			var h = $("#inputEmailAddress").val();
			var n = $("#inputPassword").val();
			var m = "Mời bạn nhập lại đầy đủ và nhấn Login";
			if (h == '' || n == '') {
				alert(m);
			} else {
