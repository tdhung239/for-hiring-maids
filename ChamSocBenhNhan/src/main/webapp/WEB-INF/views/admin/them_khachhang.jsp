...
<div class="outside"
	...
	<form:form method="post" action="/ChamSocBenhNhan/luuThemKhachHang">
		<table
			...
			<tr>
				...
				<td><form:input size="30" path="sdt"  placeholder="0273456789" type="tel" pattern="^(0[1-9][0-9]{8}|1[89]00[0-9]{4})$" required="required" /></td>
			</tr>
