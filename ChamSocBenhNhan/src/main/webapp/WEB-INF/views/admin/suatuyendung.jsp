...
<ol class="breadcrumb mb-4">
	...
	<li class="breadcrumb-item active">Cập nhật lại giới thiệu tuyển
		dụng</li>
</ol>
${param.message}
<div class="outside"
	...
	<form:form method="post" action="/ChamSocBenhNhan/luuSuaTuyenDung"
		...
		<table
			...
			<tr>
				<th colspan="2">
					<h3
						...
						SỬA DỮ LIỆU GIỚI THIỆU TUYỂN DỤNG</h3>
				</th>
			</tr>
			<tr>
				<td></td>
				<td><form:hidden path="maTuyenDung" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td style="font-size: 18px;">Chọn hình ảnh tải lên </br> (Nếu bạn
					muốn thay đổi ảnh) :&nbsp &nbsp
				</td>
